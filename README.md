...
VITE_VSCODE_WEB_URL=https://wimps-vscode.pages.dev/
```

`/classic` serves the original WIMPS IDE. `/ide` embeds the hosted VS Code web workbench from `VITE_VSCODE_WEB_URL` when that host allows framing.
